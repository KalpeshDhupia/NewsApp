...
class NewsAdapter : RecyclerView.Adapter<MainViewHolder>() {
    ...
    fun setMovies(it: NewsResponse) {
        this.articleList = it.articles as MutableList<Article>
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        holder.binding.textView.text = news.title
        holder.binding.textView2.text = news.description
